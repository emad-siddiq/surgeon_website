      ...
      <Container className="py-16 md:py-20">
        <div className="grid grid-cols-1 items-start gap-10 md:grid-cols-12">
          <div className="md:col-span-5">
            ...
            <h2 id="consultation-heading" className="t-h1 mt-3 max-w-[20ch]">
              Looking for a consultation?
            </h2>
            <p className="t-body-lg mt-5 max-w-[42ch] text-textSecondary">
              Tell us a little about your case and we’ll come back with an appointment slot. First
              consultations are unhurried — we talk through your history, goals and the honest
              trade-offs before we discuss anything operative.
            </p>
          ...
          >
            {status === 'success' ? (
              <div role="status" aria-live="polite">
                ...
                <p className="t-h3 mt-3 font-medium">We’ll be in touch within one working day.</p>
                <p className="t-body mt-3 text-textSecondary">
                  A note confirming next steps and what to prepare for your first visit is on its
                  way to the email you provided.
                </p>
              </div>
            ) : (
              <form onSubmit={onSubmit} noValidate>
                ...
                <div className="mt-6 flex flex-wrap items-center justify-between gap-4">
                  <label className="flex max-w-[48ch] items-start gap-3 text-sm text-textSecondary">
                    ...
                    />
                    I understand my information will be used only to schedule and prepare for this
                    consultation.
                  </label>
